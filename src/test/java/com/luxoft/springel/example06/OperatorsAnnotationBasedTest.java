package com.luxoft.springel.example06;
...
import com.luxoft.springel.example06.Operators;

public class OperatorsAnnotationBasedTest {
	
	private static final String APPLICATION_CONTEXT_XML_FILE_NAME = "example06/application-context.xml";
	...
	public void testOperators() {
		...
		assertEquals(op.getAddTest(), 250.0, 0.01);
